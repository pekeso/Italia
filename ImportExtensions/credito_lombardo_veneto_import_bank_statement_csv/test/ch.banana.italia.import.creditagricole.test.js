...
// @description = <TEST ch.banana.italia.import.creditolombardoveneto>
// @task = app.command
// @doctype = *.*
// @docproperties = 
// @outputformat = none
...
Test.registerTestCase(new TestImportCreditoLombardoVenetoTrans());

// Here we define the class, the name of the class is not important
function TestImportCreditoLombardoVenetoTrans() {
}

// This method will be called at the beginning of the test case
TestImportCreditoLombardoVenetoTrans.prototype.initTestCase = function () {
   this.testLogger = Test.logger;
   this.progressBar = Banana.application.progressBar;
}

// This method will be called at the end of the test case
TestImportCreditoLombardoVenetoTrans.prototype.cleanupTestCase = function () {

}

// This method will be called before every test method is executed
TestImportCreditoLombardoVenetoTrans.prototype.init = function () {

}

// This method will be called after every test method is executed
TestImportCreditoLombardoVenetoTrans.prototype.cleanup = function () {
